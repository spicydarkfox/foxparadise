lobby-state-background-warden-title = Варден
...
lobby-state-background-susstation-title = Сасстанция
lobby-state-background-susstation-artist = Alekshhh

lobby-state-background-skellyvstherev-title = Скелет против Революции
...
lobby-state-background-behonker-title = Бихонкер
lobby-state-background-behonker-artist = InCrah

lobby-state-background-terminalstation-title = Терминал Станции
lobby-state-background-terminalstation-artist = aserovich

lobby-state-background-justaweekaway-title = Всего неделя осталась
lobby-state-background-justaweekaway-artist = plantyfern

lobby-state-background-janishootout-title = Перестрелка уборщиков
lobby-state-background-janishootout-artist = psychpsyo

lobby-state-background-reclaimernuke-title = Ядерный заряд «Утилизатора»
