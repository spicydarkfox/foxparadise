...
ent-BorgModulePrying = модуль взлома
    .desc = Универсальный модуль киборга, который позволяет юниту вскрывать двери.
...
ent-XenoborgModuleDoorControl = модуль управления дверями ксеноборга
    .desc = Модуль, который позволяет ксеноборгам управлять шлюзами.
ent-XenoborgModuleTileGun = модуль ксеноборга с плиткомётом
    .desc = Модуль с плиткомётом. Стоп, с чем?
...
ent-XenoborgModuleJump = модуль ксеноборга с прыжковым ускорителем
