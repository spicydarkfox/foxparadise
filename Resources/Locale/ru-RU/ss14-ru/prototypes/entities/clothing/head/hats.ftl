...
ent-ClothingHeadHatBeretBrigmedic = берет полевого врача
    .desc = Белый берет для полевого врача.
...
ent-ClothingHeadHatFedoraPress = федора прессы
    .desc = За ленту засунута небольшая записка с надписью «ПРЕССА». Практически пропуск вездеход!
...
ent-ClothingHeadHatMitreClown = митра хонкоматери
    .desc = Прихожанам трудно заметить банановую кожуру на полу, когда они смотрят на ваше великолепное шапо.
