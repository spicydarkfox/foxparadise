...
uplink-grenade-launcher-desc = Старый гранатомёт China-Lake снаряжённый 5 гранатами.
...
uplink-syndimov-law-name = Плата законов Синдиката
uplink-syndimov-law-desc = Подрывной набор законов, который используется, чтобы переманить ИИ на свою сторону. Используйте при любой возможности.
...
uplink-voice-mask-implanter-desc = Модифицирует ваши голосовые связки, позволяя звучать как любой человек, которого вы только можете себе представить.
...
uplink-bulldog-bundle-desc = Простой и надёжный: Содержит популярный дробовик Бульдог, 1 барабан пуль и 4 барабана дроби.
...
uplink-hijack-beacon-desc = Маяк захвата производства Синдиката, предназначенный для обхода брандмауэров автоматизированных торговых станций Nanotrasen. Процесс занимает 200 секунд, и торговая станция объявит о взломе, так что подготовьтесь соответствующим образом.
